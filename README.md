...
Current release: **v1.5.7**. Releases follow Semantic Versioning; contribution
...
```bash
curl -fL https://raw.githubusercontent.com/HDR-Performance/lan-batocera/v1.5.7/standalone-install.sh -o /tmp/lan-batocera-install.sh
