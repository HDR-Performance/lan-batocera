...
class MultiplayerUiTests(unittest.TestCase):
    ...
    def test_play_page_enables_and_automates_emulatorjs_netplay(self):
        ...
        self.assertIn("HOST_ROOM_CREATE_ATTEMPTS=4", page)
        self.assertIn("createNetplayRoom(emulator,status)", page)
        self.assertIn("could not create a synchronized room after 4 attempts", page)
